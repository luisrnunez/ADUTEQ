    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.CharField(default='user', max_length=50)),
                ('password', models.CharField(default='123', max_length=20)),
                ('cedula', models.CharField(default='1250259114', max_length=10)),
                ...
                ('correo_electronico', models.EmailField(default='user@gmail.com', max_length=254)),
                ('numero_telefonico', models.CharField(default='0960138819', max_length=20)),
                ...
                ('foto', models.BinaryField(default=b'default_foto')),
