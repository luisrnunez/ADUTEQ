...
from .views import lista_pagos_cuotas_pendientes,detalles_cuota_pendiente,eliminar_pago_cuota_pendiente,registra_pago_cuota_pen,agregar_pdf2,convertir_cuotas2
