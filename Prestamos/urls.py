...
from .views import guardar_pago_cuota, guardar_prestamo, mostrar_prestamo,editar_prestamo,aplicar_pago, mostrar_detalles,mostrar_detalles_todo, aplicar_pago_cuota, eliminar_prestamo_y_cuotas, editar_detalles, guardaredicion
...
urlpatterns = [
    ...
    path('guardar_edicion/', guardaredicion , name='guardar_edicion'),
]
